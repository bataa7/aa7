const config = {
	...
	metaData: {
		title: 'aa7的个人主页🎉',
		description: '欢迎来到aa7的奇妙世界！',
		keywords: 'aa7,aa7,个人主页,个人网站',
		icon: '/favicon.ico'   //网页图标，支持外链
	},

	avatar: "/img/avatar.jpg", // 头像
	welcometitle: "刘的展厅", // 标题
	...
	projectcards: [
		...
		{ go: "🗂️ 前往", img: "/img/yejing.jpg", title: "本站数据报表", subtitle: "让数据说话", text: "If you see this line, I've managed to get your attention.", url: "https://v6.51.la/report/overview?comId=3083744", show: false },
